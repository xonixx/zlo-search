...
<div class="content">
    ...
    <ul>
        <li>Добавлен поиск по форумам: <a href="http://takeoff.mipt.ru/cgi-bin/board/index.cgi?index">форум горной секции МФТИ</a>, <a href="http://zlo.rt.mipt.ru/dev/">Programming Board</a>;</li>
