...
<div class="content">
    ...
    <ul>
        <li>Добавлен поиск по форумам: <a href="http://takeoff.mipt.ru/cgi-bin/board/index.cgi?index">форуму горной секции МФТИ</a>, <a href="http://zlo.rt.mipt.ru/dev/">Programming Board</a>;</li>
    ...
    <table border=1>
        ...
        <tr>
            <td><a href="search?st=adv&text=%F2%3F%E7&topic=-1&inTitle=on&nick=&host=&site=0&pageSize=0&submitBtn=Search">
                т?з</a></td>
            <td>"?" соответствует одной произвольной букве. Будут надены слова "таз", "туз". <i>Не работает в режиме точная фраза!</i></td>
        </tr>
        <tr>
            <td><a href="search?st=adv&text=%F1%F2%EE*&topic=-1&inTitle=on&nick=&host=&site=0&pageSize=0&submitBtn=Search">
                сто*</a></td>
            <td>"*" соответствует произвольному числу букв, включая 0. будут надены все слова, начинающиеся на "сто". <i>Не работает в режиме точная фраза!</i></td>
        </tr>
        <tr>
