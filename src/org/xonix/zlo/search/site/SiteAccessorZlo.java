...
/*    private SiteAccessorZlo() {
        super();
        END_MSG_MARK_END =          "<BIG>Сообщения в этом потоке</BIG>";
        ...
        JNDI_DS_NAME =          "java:comp/env/jdbc/zlo_storage";
    }*/

    public SiteAccessorZlo(String siteName) {
        super(siteName);
    }
}
