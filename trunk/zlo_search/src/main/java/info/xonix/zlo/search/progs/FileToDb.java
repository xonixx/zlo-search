...
*/
            ...
            do {
                ...
                List<Message> msgs = new ArrayList<Message>(lines.length - 1);
    ...
    private int formTopicCode(String category) {
        ...
        switch (cat) {
            ...
            case 6:
                return 10; // куплю
            case 7:
                return 8; // движок борды
            case 8:
                return 7; // развлечения
            case 9:
                return 11; // продам
            case 10:
                return 18; // temp
            ...
            case 13:
                return 13; // win
            case 14:
                return 15; // проблемы сети
            case 15:
                return 5; // новости
            case 16:
                return 16; // голосование
            case 17:
                return -1; //?
            case 18:
                return 6; // спорт
    ...
    private String formTopic(String category) {
        ...
        switch (cat) {
            case 0:
                return "Без темы"; // без темы
            case 1:
                return "Мурзилка"; // мурзилка
            case 2:
                return "Программирование"; // программирование
            case 3:
                return "Работа"; // работа
            case 4:
                return "Учеба"; // учеба
            case 5:
                return "Обсуждение"; // обсуждение
            case 6:
                return "Куплю"; // куплю
            case 7:
                return "Движок борды"; // движок борды
            case 8:
                return "Развлечения"; // развлечения
            case 9:
                return "Продам"; // продам
            case 10:
                return "Temp"; // temp
            case 11:
                return "Услуги"; // услуги
            case 12:
                return "?"; //?
            case 13:
                return "Windows"; // win
            case 14:
                return "Проблемы сети"; // проблемы сети
            case 15:
                return "Новости"; // новости
            case 16:
                return "Голосование"; // голосование
            case 17:
                return "?"; //?
            case 18:
                return "Спорт"; // спорт
