 ...
 * generated in the info.xonix.zlo.search.xmlfp.xjccompiled.message package.
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: info.xonix.zlo.search.xmlfp.xjccompiled.message
     */
