...
rmdir /S /Q %OUT_DIR%
call xjc.bat -p info.xonix.zlo.search.forumxmlprotocol.xjccompiled.message -d %SRC_DIR% message.xsd
call xjc.bat -p info.xonix.zlo.search.forumxmlprotocol.xjccompiled.lastMessageNumber -d %SRC_DIR% lastMessageNumber.xsd
